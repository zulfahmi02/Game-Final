...
<body>
    <div class="navbar">
        <h1>✏️ Edit Poster</h1>
        <div>
            <a href="<?php echo e(route('admin.posters')); ?>">Kembali</a>
    ...
    <div class="container">
        <div class="card">
            <form action="<?php echo e(route('admin.posters.update', $poster->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                
                <div class="form-group">
                    <label for="title">Judul Poster *</label>
                    <input type="text" id="title" name="title" value="<?php echo e($poster->title); ?>" required placeholder="Contoh: Belajar Huruf Hijaiyah">
                </div>

                <div class="form-group">
                    <label for="description">Deskripsi</label>
                    <textarea id="description" name="description" placeholder="Deskripsi singkat tentang poster"><?php echo e($poster->description); ?></textarea>
                </div>

                <div class="form-group">
                    <label for="category">Kategori</label>
                    <input type="text" id="category" name="category" value="<?php echo e($poster->category); ?>" placeholder="Contoh: Bahasa Arab, Matematika, dll">
                </div>

                <div class="form-group">
                    <label for="order">Urutan Tampil</label>
                    <input type="number" id="order" name="order" value="<?php echo e($poster->order); ?>" min="0" placeholder="0">
                ...
                <div class="form-group">
                    ...
                    <div style="display: flex; gap: 20px; margin-top: 8px;">
                        <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                            <input type="radio" name="is_active" value="1" <?php echo e($poster->is_active ? 'checked' : ''); ?>>
                            <span>✅ Aktif</span>
                        </label>
                        <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                            <input type="radio" name="is_active" value="0" <?php echo e(!$poster->is_active ? 'checked' : ''); ?>>
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo e(route('admin.posters')); ?>" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\Game\resources\views/admin/posters/edit.blade.php ENDPATH**/ ?>