...
<head>
    ...
    <title>Kelola Soal - <?php echo e($game->title); ?></title>
    <style>
...
<body>
    ...
    <div class="container">
        <div class="game-info">
            <h2 style="color: #333; margin-bottom: 5px;"><?php echo e($game->title); ?></h2>
            <p style="color: #666;"><?php echo e($game->description); ?></p>
        </div>

        <div class="header">
            <h3>Daftar Soal (<?php echo e($questions->count()); ?> soal)</h3>
            <a href="<?php echo e(route('admin.questions.create', $game->id)); ?>" class="btn btn-primary">+ Tambah Soal</a>
        </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(Str::limit($question->question_text, 60)); ?></td>
                                <td><code><?php echo e($question->correct_answer); ?></code></td>
                                <td><?php echo e($question->points); ?></td>
                                <td>
                                    <span class="badge badge-<?php echo e($question->difficulty); ?>">
                                ...
                                <td>
                                    <div class="actions">
                                        <a href="<?php echo e(route('admin.questions.edit', $question->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
                                        <form action="<?php echo e(route('admin.questions.delete', $question->id)); ?>" method="POST" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus soal ini?')">
                                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Game\resources\views/admin/questions/index.blade.php ENDPATH**/ ?>