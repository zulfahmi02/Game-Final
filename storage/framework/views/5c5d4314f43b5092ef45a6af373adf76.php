...
<head>
    ...
    <title>Tambah Soal - <?php echo e($game->title); ?></title>
    <style>
...
<body>
    <div class="navbar">
        ...
        <div>
            <a href="<?php echo e(route('admin.questions', $game->id)); ?>">Kembali</a>
    ...
    <div class="container">
        <div class="game-info">
            <strong>Game:</strong> <?php echo e($game->title); ?>
        ...
        <div class="card">
            <form action="<?php echo e(route('admin.questions.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo e(route('admin.questions', $game->id)); ?>" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\Game\resources\views/admin/questions/create.blade.php ENDPATH**/ ?>