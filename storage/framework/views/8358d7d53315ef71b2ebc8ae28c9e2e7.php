...
<body>
    ...
    <a href="<?php echo e(route('home')); ?>" class="back-btn">← Kembali ke Home</a>
    ...
    <header>
        ...
        <?php if(session('student_name')): ?>
            <p style="font-size: 1.8rem; color: #1e3a8a; margin-top: 20px; font-weight: bold; background: rgba(255,255,255,0.8); padding: 15px 30px; border-radius: 50px; display: inline-block; box-shadow: 0 8px 20px rgba(30,58,138,0.2);">
                🎉 Selamat datang, <?php echo e(session('student_name')); ?>! 🎉
            </p>
        <?php endif; ?>
    </header>
            ...
            <div class="game-card">
                <div class="game-placeholder">
                    <?php if($game->thumbnail): ?>
                        <img src="<?php echo e(asset($game->thumbnail)); ?>" alt="<?php echo e($game->title); ?>" style="width: 100%; height: 100%; object-fit: cover; border-radius: 25px;">
                    <?php else: ?>
                        🎮
                    <?php endif; ?>
                </div>
                ...
                <form action="<?php echo e(route('games.start', $game->slug)); ?>" method="POST" style="margin: 0;">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Game\resources\views/game/index.blade.php ENDPATH**/ ?>