...
<body>
    <div class="navbar">
        ...
        <div class="user-info">
            <span>Halo, <?php echo e(session('admin_name')); ?>!</span>
            <a href="<?php echo e(route('admin.logout')); ?>" class="btn btn-light">Logout</a>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <h3>Total Game</h3>
                <div class="number"><?php echo e($totalGames); ?></div>
            </div>
            <div class="stat-card">
                <h3>Total Soal</h3>
                <div class="number"><?php echo e($totalQuestions); ?></div>
            </div>
            <div class="stat-card">
                <h3>Game Aktif</h3>
                <div class="number"><?php echo e($activeGames); ?></div>
            </div>
        </div>
        ...
        <div class="menu-grid">
            <div class="menu-card">
                ...
                <a href="<?php echo e(route('admin.games')); ?>" class="btn btn-primary">Kelola Game</a>
            </div>
            ...
            <div class="menu-card">
                ...
                <a href="<?php echo e(route('admin.parents')); ?>" class="btn btn-primary">Kelola Orang Tua</a>
            </div>
            ...
            <div class="menu-card">
                ...
                <a href="<?php echo e(route('admin.posters')); ?>" class="btn btn-primary">Kelola Poster</a>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\Game\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>