...
<body>
    ...
    <div class="container">
        <div class="card">
            <form action="<?php echo e(route('admin.posters.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Game\resources\views/admin/posters/create.blade.php ENDPATH**/ ?>